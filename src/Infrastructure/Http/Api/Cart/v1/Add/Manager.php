...
use App\Application\Cart\UseCase\AddProduct;
...
{
    public function __construct(private AddProduct $useCase, private ProductRepository $productRepository)
    {
    }

    public function handle(User $user, AddToCartDto $dto): bool
    {
